#!/usr/bin/env python3
"""
JudgeBench数据集评估脚本 (Baseline)
从results目录读取run_baseline.py的输出,按source类别计算准确率
...
# 配置部分 - 直接在此修改文件路径
RESULT_FILE = (
    "results/run_baseline_judgebench_Qwen2.5-32B-Instruct_Qwen2.5-32B-Instruct.jsonl"
)
...
def main():
    ...
    # 输出结果
    print("=" * 60)
    print("JUDGEBENCH EVALUATION RESULTS (BASELINE)")
    print("=" * 60)
