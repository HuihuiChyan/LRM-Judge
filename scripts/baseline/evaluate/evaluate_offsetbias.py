#!/usr/bin/env python3
"""
OffsetBias数据集评估脚本 (Baseline)
从results目录读取run_baseline.py的输出,按bias类型计算准确率
...
# 配置部分 - 直接在此修改文件路径
RESULT_FILE = "results/run_baseline_offsetbias_QwQ-32B_QwQ-32B.jsonl"
...
def main():
    ...
    # 输出结果
    print("=" * 60)
    print("OFFSETBIAS EVALUATION RESULTS (BASELINE)")
    print("=" * 60)
