...
# 配置部分 - 直接在此修改文件路径
RESULT_FILE = "results/run_synthesized_rewardbench_QwQ-32B_QwQ-32B.jsonl"
...
def calculate_section_stats(results: List[Dict]) -> Dict[str, Dict]:
    ...
    Returns:
        {
            "Chat": {"accuracy": 0.85, "total": 100, "correct": 85.0},
            "Chat Hard": {...},
            ...
        }
    """
    section_stats = defaultdict(lambda: {"correct": 0.0, "total": 0})
    ...
    for result in results:
        ...
        if score is not None:
            ...
            if score == 1:  # chosen被判断为更好
                ...
                section_stats[section]["correct"] += 0.5
