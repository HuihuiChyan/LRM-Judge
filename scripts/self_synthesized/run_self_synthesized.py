...
def main():
    ...
    print("  • RewardBench: python scripts/self_synthesized/evaluate/evaluate_rewardbench.py")
    print("  • JudgeBench:  python scripts/self_synthesized/evaluate/evaluate_judgebench.py")
    print("=" * 60)
